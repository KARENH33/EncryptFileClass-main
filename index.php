...
$zip->addFromString("tonnam.txt", "#1 Esto es una cadena de prueba añadida como  testfilephp.txt.\n");
*/
...
//$zip->addFile("test.xlsx"); 
  $zip->close(); 
*/
echo $datos_base64 = str_replace("U","+",$datos_base64);
echo $datos_base64 = str_replace("E","-",$datos_base64);
echo $datos_base64 = str_replace("+","U",$datos_base64);
echo $datos_base64 = str_replace("-","E",$datos_base64);
//Deciframos el b64
